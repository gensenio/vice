...
${CC:-cc} -DHAVE_CONFIG_H -I"$config_build/src" -I"$root/src" -I"$root/src/plus4" \
    ...
    ${CFLAGS:-} "$root/tests/plus4/ted-bitmap-write-test.c" "$root/src/plus4/ted-counter.c" "$root/src/plus4/ted-fetch.c" \
    -Wl,--gc-sections -o "$build/ted-bitmap-write-test"
"$build/ted-bitmap-write-test"
